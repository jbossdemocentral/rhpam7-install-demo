...
Function Import-ImageStreams-And-Templates() {
  ...
  Call-Oc "create -f https://raw.githubusercontent.com/jboss-container-images/rhpam-7-openshift-image/$OPENSHIFT_PAM7_TEMPLATES_TAG/rhpam74-image-streams.yaml" $True "Error importing Image Streams" $True
  ...
  Call-Oc "import-image rhpam74-businesscentral-openshift:$IMAGE_STREAM_TAG —confirm -n $($PRJ[0])" $True "Error fetching Image Streams."
  Call-Oc "import-image rhpam74-kieserver-openshift:$IMAGE_STREAM_TAG —confirm -n $($PRJ[0])" $True "Error fetching Image Streams."
  ...
  Call-Oc "create -f https://raw.githubusercontent.com/jboss-container-images/rhpam-7-openshift-image/$OPENSHIFT_PAM7_TEMPLATES_TAG/templates/rhpam74-authoring.yaml" $True "Error importing Template" $True
}
...
Function Create-Application() {
  ...
  $argList = "new-app --template=rhpam74-authoring"`
